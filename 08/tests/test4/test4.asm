...
0;JMP
(Main.main)
@Main.Stata.init$returnAddress.1
D=A
@SP
A=M
M=D
...
A=M
M=D
@Main.Statb.init$returnAddress.2
D=A
@SP
A=M
M=D
...
@SP
M=M+1
@Main.Main.dump$returnAddress.4
D=A
@SP
A=M
M=D
...
@SP
M=M+1
@Main.Stata.setVal$returnAddress.5
D=A
@SP
A=M
M=D
...
@SP
M=M-1
@Main.Statb.setVal$returnAddress.6
D=A
@SP
A=M
M=D
...
@SP
M=M+1
@Main.Main.dump$returnAddress.7
D=A
@SP
A=M
M=D
...
@SP
M=M+1
@Main.Stata.getVal$returnAddress.8
D=A
@SP
A=M
M=D
...
A=M
M=D
@Main.Statb.getVal$returnAddress.9
D=A
@SP
A=M
M=D
...
@SP
M=M+1
@Main.Memory.poke$returnAddress.10
D=A
@SP
A=M
M=D
...
@SP
M=M+1
@Main.Memory.poke$returnAddress.11
D=A
@SP
A=M
M=D
